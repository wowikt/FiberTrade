...
namespace FifteenGame.Web
{
    ...
    /// </summary>
    public class FifteenGameNavigationProvider : NavigationProvider
    {
        ...
        {
            return new LocalizableString(name, FifteenGameConsts.LocalizationSourceName);
        }
    }
}
