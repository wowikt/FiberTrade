...
using FifteenGame.Sessions;
using FifteenGame.Web.Controllers.Results;
using FifteenGame.Web.Models;
using FifteenGame.Web.Models.Account;
...
{
    public class AccountController : FifteenGameControllerBase
    {
